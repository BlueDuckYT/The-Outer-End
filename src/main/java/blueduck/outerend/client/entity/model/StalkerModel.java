...
public class StalkerModel extends EntityModel<StalkerEntity> {
	...
	public StalkerModel() {
		...
		haunchRight2 = new ModelRenderer(this);
		haunchRight2.setRotationPoint(-3.0F, -2.5152F, -4.1264F);
		body.addChild(haunchRight2);
		setRotationAngle(haunchRight2, 0.1745F, 0.0F, 0.0F);
		haunchRight2.setTextureOffset(0, 0).addBox(-3.0F, -2.9924F, -3.349F, 3.0F, 10.0F, 7.0F, 0.0F, true);
		haunchRight2.setTextureOffset(53, 0).addBox(-2.0F, 7.0076F, 0.651F, 2.0F, 11.0F, 3.0F, 0.0F, true);

		rearFootRight2 = new ModelRenderer(this);
		rearFootRight2.setRotationPoint(0.0F, 22.0F, 2.0F);
		haunchRight2.addChild(rearFootRight2);
		...
		frontLegRight2 = new ModelRenderer(this);
		frontLegRight2.setRotationPoint(-3.0F, -2.0456F, -18.4791F);
		body.addChild(frontLegRight2);
		setRotationAngle(frontLegRight2, 0.1745F, 0.0F, 0.0F);
		frontLegRight2.setTextureOffset(0, 26).addBox(-4.0F, -2.6947F, -1.9933F, 4.0F, 11.0F, 5.0F, 0.0F, true);
		frontLegRight2.setTextureOffset(28, 54).addBox(-2.5F, 20.3053F, 2.0067F, 1.0F, 10.0F, 4.0F, 0.0F, true);

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(4.0F, 24.0F, 12.0F);
		frontLegRight2.addChild(bone2);
		...
		head.setTextureOffset(45, 18).addBox(-1.5F, -7.0F, -3.0F, 2.0F, 2.0F, 9.0F, 0.0F, false);
	...
	public void setRotationAngles(StalkerEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.frontLegRight2.rotateAngleX = -frontLegRight.rotateAngleX;
		this.haunchRight.rotateAngleX = -frontLegRight.rotateAngleX;
		this.haunchRight2.rotateAngleX = frontLegRight.rotateAngleX;
...
//		this.head.rotateAngleX = headPitch;
