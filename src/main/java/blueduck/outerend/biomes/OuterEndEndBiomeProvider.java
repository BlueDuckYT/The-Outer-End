...
public class OuterEndEndBiomeProvider extends BiomeProvider {
	public static final Codec<OuterEndEndBiomeProvider> CODEC = RecordCodecBuilder.create((builder) -> {
		...
		})).apply(builder, builder.stable(OuterEndEndBiomeProvider::new));
	});
	...
	public OuterEndEndBiomeProvider(Registry<Biome> lookupRegistry, long seed) {
	...
	private OuterEndEndBiomeProvider(Registry<Biome> lookupRegistry, long seed, Biome theEndBiome, Biome endHighlandsBiome, Biome endMidlandsBiome, Biome smallEndIslandsBiome, Biome endBarrensBiome) {
	...
	public BiomeProvider getBiomeProvider(long seed) {
		return new OuterEndEndBiomeProvider(this.lookupRegistry, seed, this.theEndBiome, this.endHighlandsBiome, this.endMidlandsBiome, this.smallEndIslandsBiome, this.endBarrensBiome);
	}
