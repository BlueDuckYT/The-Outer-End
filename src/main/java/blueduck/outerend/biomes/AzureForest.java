...
public class AzureForest extends OuterEndBiome {
	...
	static {
		...
		SPAWN_SETTINGS.withSpawnCost(EntityRegistry.DRAGONFLY.get(), 1, 5);
		SPAWN_SETTINGS.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityRegistry.DRAGONFLY.get(), 10, 1, 3));
