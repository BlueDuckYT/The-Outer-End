...
public class CommonSetup {
	...
	public static void afterCommonSetup() {
		...
		EntitySpawnPlacementRegistry.register(EntityRegistry.CHORUS_SQUID.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ChorusSquidEntity::shouldSpawn);
	}
}
